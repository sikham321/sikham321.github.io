const config = {
    serverInfo: {
        ...
        serverName: "Ryuu Nodes", /*Server name*/
        serverIp: "RYUU NODES", /*Server IP*/
        discordServerID: "1102960676277866568" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
